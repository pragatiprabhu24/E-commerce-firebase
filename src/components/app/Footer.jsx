    ...
    >
      ...
      >
        <div className="container px-5 py-3 mx-auto flex items-center sm:flex-row flex-col">
          ...
          <p className="flex gap-2 text-sm text-white font-bold sm:ml-6 sm:mt-0 mt-4">
            Made with {" "}
            <img
          ...
          <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
            ...
            <a className="ml-3 text-gray-100">
              <img
                src="https://freelogopng.com/images/all_img/1657043345twitter-logo-png.png"
                className="w-5"
              />
            </a>
            <a className="ml-3 text-gray-100">
              <img
                src="https://pngimg.com/d/instagram_PNG9.png"
                className="w-5"
              />
            </a>
            <a className="ml-3 text-gray-100">
