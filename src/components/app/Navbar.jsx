    ...
    <>
      <div className="bg-white sticky top-0 z-50  "  >
        ...
        <header className="relative bg-white">
          <p className="flex h-10 items-center justify-center bg-yellow-300 px-4 text-sm font-medium text-black sm:px-6 lg:px-8" style={{ backgroundColor: mode === 'dark' ? 'rgb(62 64 66)' : '', color: mode === 'dark' ? 'white' : '', }}>
              ...
              <div className="flex h-16 items-center">
                  ...
                  <Link to={'/'} className='flex'>
                    <div className="flex ">
                      <h1 className=' text-2xl font-bold text-black  px-2 py-1 rounded' style={{ color: mode === 'dark' ? 'white' : '', }}>
                        <img src="https://upload.wikimedia.org/wikipedia/commons/b/ba/Yuniq-ecommerce_logo_schwarz.png" className='w-40' />
                      </h1>
                    </div>
                  </Link>
                </div>
                ...
                <div className="ml-auto flex items-center">
                  <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                    ...
                    <a className="text-sm font-medium text-gray-700 cursor-pointer" onClick={handleOpenRegister} style={{ color: mode === 'dark' ? 'white' : '', }}>
                      Login
                    </a>
                  </div>
                  ...
                  <div className="ml-4 flow-root lg:ml-6">
                    <a href="#" className="flex items-center text-gray-700 ">
                      <img
                        className="inline-block w-10 h-10 rounded-full"
                        src="https://img.jagrantv.com/article/rc1032152/1654777391-jannat-zubair-rahmani.jpg"
                        alt="Dan_Abromov" />
                    </a>
                  </div>
                </div>
