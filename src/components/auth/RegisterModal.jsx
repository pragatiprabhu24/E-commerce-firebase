                                        ...
                                        <section className="flex flex-col md:flex-row justify-center space-y-10 md:space-y-0 md:space-x-16 items-center my-2 mx-5 md:mx-0 md:my-0">
                                            ...
                                            <div className="md:w-1/3 max-w-sm">
                                                ...
                                                <div className="my-5 flex items-center before:mt-0.5 before:flex-1 before:border-t before:border-neutral-300 after:mt-0.5 after:flex-1 after:border-t after:border-neutral-300">
                                                    <p className="mx-4 mb-0 text-xl text-center font-bold text-gray-900">Sign Up</p>
                                                </div>
                                                <input
                                                ...
                                                <div className="mt-4 font-semibold text-sm text-slate-500 text-center md:text-left">
                                                    ...
                                                    <a className="ml-2 text-red-600 hover:underline hover:underline-offset-4 cursor-pointer"
