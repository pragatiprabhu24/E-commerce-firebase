    ...
    <Layout>
      <div class="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
        ...
        <div class="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
          ...
          <p class="text-gray-400">Complete your order by providing your address details.</p>
          <div class="">
            ...
            <label for="card-no" class="mt-4 mb-2 block text-sm font-medium">Mobile Number</label>

            <div class="relative">
              <input type="text" id="card-no" name="card-no" class="w-full rounded-md border border-gray-200 px-2 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="ENTER YOUR MOBILE NUMBER" />
              <div class="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
            ...
            <div class="flex flex-col sm:flex-row">
              ...
              <input type="text" name="billing-zip" class="flex-shrink-0 sm:w-5/12 rounded-md border border-gray-200 px-4 py-3 text-sm shadow-sm outline-none sm:w-1/6 focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="ZIP" />
            </div>
